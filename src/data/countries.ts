export const countries = [
  ...
  { code: "+1441", name: "Bermuda", isoCode: "BM" },
  ...
  { code: "+500", name: "Falkland Islands", isoCode: "FK" },
  { code: "+298", name: "Faroe Islands", isoCode: "FO" },
  { code: "+679", name: "Fiji", isoCode: "FJ" },
  { code: "+358", name: "Finland", isoCode: "FI" },
  { code: "+33", name: "France", isoCode: "FR" },
  { code: "+594", name: "French Guiana", isoCode: "GF" },
  { code: "+689", name: "French Polynesia", isoCode: "PF" },
  { code: "+241", name: "Gabon", isoCode: "GA" },
  { code: "+220", name: "Gambia", isoCode: "GM" },
  { code: "+7880", name: "Georgia", isoCode: "GE" },
  { code: "+49", name: "Germany", isoCode: "DE" },
  { code: "+233", name: "Ghana", isoCode: "GH" },
  { code: "+350", name: "Gibraltar", isoCode: "GI" },
  { code: "+30", name: "Greece", isoCode: "GR" },
  { code: "+299", name: "Greenland", isoCode: "GL" },
  { code: "+1473", name: "Grenada", isoCode: "GD" },
  { code: "+590", name: "Guadeloupe", isoCode: "GP" },
  { code: "+671", name: "Guam", isoCode: "GU" },
  ...
  { code: "+850", name: "Korea - North", isoCode: "KP" },
  { code: "+82", name: "Korea - South", isoCode: "KR" },
  ...
  { code: "+417", name: "Liechtenstein", isoCode: "LI" },
  { code: "+370", name: "Lithuania", isoCode: "LT" },
  { code: "+352", name: "Luxembourg", isoCode: "LU" },
  { code: "+853", name: "Macao", isoCode: "MO" },
  { code: "+389", name: "Macedonia", isoCode: "MK" },
  ...
  { code: "+269", name: "Mayotte", isoCode: "MU" },
  ...
  { code: "+1664", name: "Montserrat", isoCode: "MS" },
  ...
  { code: "+672", name: "Norfolk Islands", isoCode: "NF" },
  {
    code: "+670",
  ...
  { code: "+1787", name: "Puerto Rico", isoCode: "PR" },
  { code: "+974", name: "Qatar", isoCode: "QA" },
  { code: "+262", name: "Reunion", isoCode: "CG" },
  ...
  { code: "+421", name: "Slovak Republic", isoCode: "SK" },
  { code: "+386", name: "Slovenia", isoCode: "SL" },
  ...
  { code: "+290", name: "St. Helena", isoCode: "SH" },
  { code: "+1869", name: "St. Kitts", isoCode: "KN" },
  { code: "+1758", name: "St. Lucia", isoCode: "LC" },
  ...
  { code: "+1", name: "Virgin Islands - US", isoCode: "VI" },
  {
    code: "+681",
    name: "Wallis & Futuna",
    isoCode: "WF",
  },
  { code: "+969", name: "Yemen", isoCode: "YE" },
